...
export class ErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: unknown, info: { componentStack?: string | null }) {
    ...
    // forwardErrorsToLogs would catch this anyway. What it would not carry is which
    // part of the tree stopped rendering, and that is the half that says where to look.
    reportError("render failed", error, { componentStack: info.componentStack ?? undefined });
  }
