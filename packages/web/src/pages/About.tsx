...
export function About() {
  return (
    <Prose title="What this is">
      ...
      <p>
        Your browser runs a miner compiled to WebAssembly from{" "}
        <strong>cpuminer-multi</strong>, the same C code a desktop miner uses. It hashes MinotaurX,
        an algorithm chosen because it resists the specialised hardware that makes browser mining
        pointless on every well-known coin. The work goes to a mining pool through this server, and
        the proceeds go to the site owner. That is the deal, stated plainly: you spend electricity,
        a listing you chose gains rank.
      </p>
      <p>
